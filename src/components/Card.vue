<template>
  <!-- <div class="h-96 w-96 rounded-xl shadow-sm hover:shadow-lg text-center border bg-white">
    <span class="material-icons mx-auto mt-6" style="font-size:60px;">{{data.icon}}</span>
    <div class="text-3xl my-6">{{data.title}}</div>
